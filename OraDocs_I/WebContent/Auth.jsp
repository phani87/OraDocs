		...
		<div class="Absolute-Center is-Responsive">
			...
			<div class="col-sm-12 col-md-10 col-md-offset-1">
				<form action="AuthServlet" method="get" id="loginForm">
					...
					<div class="form-group input-group">
						<span class="input-group-addon"><i
							class="glyphicon glyphicon-folder-close"></i></span> <input type="text"
							name="master_folder" id="folderID" class="form-control"
							placeholder="Enter Folder ID">
					</div>
					<div class="form-group">
						<input type="submit" class="btn btn-primary" value="Update"
							name="Update"><label style="color: black;"> To generate your token </label><a href='#'
